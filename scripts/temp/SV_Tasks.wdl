...
task Get_Sample_Name {
  ...
  runtime {
    ...
    #docker: "gcr.io/washu-genome-inh-dis-analysis/extract-sv-reads@sha256:192090f72afaeaaafa104d50890b2fc23935c8dc98988a9b5c80ddf4ec50f70c"
    cpu: "1"
    memory: "1 GB"
    disks: "local-disk " + ceil( size(input_cram, "GB") + 2.0) + " HDD"
    #disks: "local-disk " + ceil( size(input_cram, "GB") + 12.0) + " HDD"
    preemptible: preemptible_tries
  }
